...
image2 = Image.open('D:/Code/Crop Recommendation/Crop Recommendation/b1.jpg')
...
#
label_l1 = tk.Label(root, text="Crop_Recommendation_System",font=("Times New Roman", 30, 'bold'),
